...
import { City4uRedirectionData, City4uRedirectionIntegration } from '@integrations/crawlers/city4u/city4u-redirection.integration';
...
@Injectable()
export class City4uRedirectionService {
    constructor(
        ...
        private city4uRedirectionIntegration: City4uRedirectionIntegration,
    ) {}
    ...
    async redirect(
        ...
        //////////////////////////////////////////////////////////////////
        // Setup the data
        const data: City4uRedirectionData = {
        ...
        const redirectionData = plainToClass(City4uRedirectionData, data);

        this.logger.debug({
            message: 'Redirection data for City4u',
        ...
        try {
            const response = await this.city4uRedirectionIntegration.redirectInfringement(redirectionData);
            ...
            this.logger.debug({ message: 'City4u Response', detail: response, fn: this.redirect.name });
        } catch (e) {
