...
export class VehicleSpreadsheetService extends SpreadsheetService {
    constructor(private http: HttpService) {
        super();
    }

    verify(file: File, body: SpreadsheetUploadDto): Observable<SpreadsheetUploadCompleteResponse> {
        return this.http.uploadFile('vehicle/spreadsheet/verify', file, body);
    }

    upload(file: File, body: SpreadsheetUploadDto): Observable<SpreadsheetUploadCompleteResponse> {
        return this.http.uploadFile('vehicle/spreadsheet/upload', file, body);
    }
