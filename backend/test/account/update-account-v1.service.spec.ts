    ...
    describe('Update Account V1 Service', () => {
        it(
            ...
            runInTransaction(async () => {
                ...
                const updateAccountData: UpdateAccountV1Dto = plainToClass(UpdateAccountV1Dto, {
                    name,
                    primaryContact,
                    role,
                });
        ...
        it(
            ...
            runInTransaction(async () => {
                ...
                /* Updating location information has been blocked for UpdateAccountV1Service */
