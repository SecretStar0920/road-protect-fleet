...
export class PoliceRedirection1615552707680 implements MigrationInterface {
    name = 'PoliceRedirection1615552707680';

    // This adds Police to the nomination_redirectiontype_enum and integration_request_log_type_enum
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "nomination_redirectiontype_enum" AS ENUM('Manual Email', 'ATG Integration', 'Manual Upload', 'External', 'Telaviv', 'Jerusalem', 'Police')`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "nomination_redirectiontype_enum_old" AS ENUM('Manual Email', 'ATG Integration', 'Manual Upload', 'External', 'Telaviv', 'Jerusalem')`,
        );
        await queryRunner.query(
