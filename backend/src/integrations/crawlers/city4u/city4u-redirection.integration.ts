...
export class City4uRedirectionDetails extends RedirectionDetails {
    @IsString()
    carNumber: string;
    @IsString()
    externalCode: string;
...
export class City4uRedirectionData extends RedirectionData {
    @IsString()
...
@Injectable()
export class City4uRedirectionIntegration extends RedirectionIntegration {
    constructor() {
        super(Integration.City4uRedirectInfringement, crawlers.city4u);
    }

    getBody(redirectionData: City4uRedirectionData): City4uRedirectionDetails {
        const body: City4uRedirectionDetails = {
        ...
        return plainToClass(City4uRedirectionDetails, body);
    }
}
