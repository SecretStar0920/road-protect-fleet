...
import { PoliceRedirectionData, PoliceRedirectionIntegration } from '@integrations/crawlers/police/police-redirection.integration';
...
@Injectable()
export class PoliceRedirectionService {
    constructor(
        ...
        private policeRedirectionIntegration: PoliceRedirectionIntegration,
    ) {}
    ...
    async redirect(
        ...
        //////////////////////////////////////////////////////////////////
        // Setup the data
        const data: PoliceRedirectionData = {
        ...
        const redirectionData = plainToClass(PoliceRedirectionData, data);

        this.logger.debug({
            message: 'Redirection data for Police',
        ...
        try {
            const response = await this.policeRedirectionIntegration.redirectInfringement(redirectionData);
            ...
            this.logger.debug({ message: 'Police Response', detail: response, fn: this.redirect.name });
        } catch (e) {
