...
@Component({
    selector: 'rp-current-account-page',
    templateUrl: './current-account-page.component.html',
    styleUrls: ['./current-account-page.component.less'],
})
export class CurrentAccountPageComponent implements OnInit, OnDestroy {
