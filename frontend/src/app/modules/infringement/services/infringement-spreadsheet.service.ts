...
export class InfringementSpreadsheetService extends SpreadsheetService {
    constructor(private http: HttpService) {
        super();
    }

    verify(file: File, body: SpreadsheetUploadDto): Observable<SpreadsheetUploadCompleteResponse> {
        return this.http.uploadFile('infringement/spreadsheet/verify', file, body);
    }

    upload(file: File, body: SpreadsheetUploadDto): Observable<SpreadsheetUploadCompleteResponse> {
        return this.http.uploadFile('infringement/spreadsheet/upload', file, body);
    }
