...
@Component({
    selector: 'rp-current-account-users-page',
    templateUrl: './current-account-users-page.component.html',
    styleUrls: ['./current-account-users-page.component.less'],
})
export class CurrentAccountUsersPageComponent implements OnInit, OnDestroy {
