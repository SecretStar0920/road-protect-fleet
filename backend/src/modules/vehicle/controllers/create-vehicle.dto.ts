...
export class CreateVehicleDto {
    @IsDefined()
    @ApiProperty({ description: 'The vehicle registration number', example: '51729193' })
    ...
    @IsString()
    @IsDefined()
    @ApiProperty({ description: 'The vehicle manufacturer', example: 'Ford', default: Config.get.vehicle.defaultManufacturer })
    @Default(Config.get.vehicle.defaultManufacturer)
    manufacturer: string;
