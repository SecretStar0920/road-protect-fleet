...
export class AdditionalNominationStatuses1581324563887 implements MigrationInterface {
    name = 'AdditionalNominationStatuses1581324563887';
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `CREATE TYPE "nomination_status_enum" AS ENUM('Pending', 'Acknowledged', 'Approved for Payment', 'Appealed', 'Manually Paid', 'Paid', 'Closed')`,
            undefined,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
            `CREATE TYPE "nomination_status_enum_old" AS ENUM('Pending', 'Acknowledged', 'Approved for Payment', 'Appealed', 'Manually Paid')`,
            undefined,
        );
        await queryRunner.query(`ALTER TABLE "nomination" ALTER COLUMN "status" DROP DEFAULT`, undefined);
        await queryRunner.query(
