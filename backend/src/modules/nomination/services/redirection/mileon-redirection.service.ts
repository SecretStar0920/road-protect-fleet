...
import { MileonRedirectionData, MileonRedirectionIntegration } from '@integrations/crawlers/mileon/mileon-redirection.integration';
...
@Injectable()
export class MileonRedirectionService {
    constructor(
        ...
        private mileonRedirectionIntegration: MileonRedirectionIntegration,
    ) {}
    ...
    async redirect(
        ...
        //////////////////////////////////////////////////////////////////
        // Setup the data
        const data: MileonRedirectionData = {
        ...
        const redirectionData = plainToClass(MileonRedirectionData, data);

        this.logger.debug({
            message: 'Redirection data for Mileon',
        ...
        try {
            const response = await this.mileonRedirectionIntegration.redirectInfringement(redirectionData);
            ...
            this.logger.debug({ message: 'Mileon Response', detail: response, fn: this.redirect.name });
        } catch (e) {
