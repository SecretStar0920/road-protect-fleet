...
@Component({
    selector: 'rp-current-account-vehicles-page',
    templateUrl: './current-account-vehicles-page.component.html',
    styleUrls: ['./current-account-vehicles-page.component.less'],
})
export class CurrentAccountVehiclesPageComponent implements OnInit, OnDestroy {
