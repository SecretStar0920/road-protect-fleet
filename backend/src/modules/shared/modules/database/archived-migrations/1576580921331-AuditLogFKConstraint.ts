...
export class AuditLogFKConstraint1576580921331 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `ALTER TABLE "audit_log" ADD CONSTRAINT "FK_2621409ebc295c5da7ff3e41396" FOREIGN KEY ("userId") REFERENCES "user"("userId") ON DELETE SET NULL ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "audit_log" ADD CONSTRAINT "FK_d64a1164e72b0121fbc07378017" FOREIGN KEY ("accountId") REFERENCES "account"("accountId") ON DELETE SET NULL ON UPDATE NO ACTION`,
        );
    }
